...
/**
 * Created by Aryan Soni on 2/9/2018.
 */


public class CustomRecyclerAdapter extends FeatureRecyclerViewAdapter<CustomRecyclerAdapter.CustomRecyclerViewHolder> {
    ...
    public CustomRecyclerViewHolder onCreateFeaturedViewHolder(ViewGroup parent, int viewType) {
        return new CustomRecyclerViewHolder(
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.simple_recycler_view_layout, parent, false));
    }
